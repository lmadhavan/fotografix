...
#define HID_INDICATOR_ZOOM                      0x10082
#define HID_INDICATOR_SIZE                      0x10083
#define HID_INDICATOR_LAYER                     0x10084
#define HID_INDICATOR_CHANNEL                   0x10085
#define HID_TOOL_RSELECT                        0x12710
#define HID_TOOL_ESELECT                        0x12711
#define HID_TOOL_WAND                           0x12712
#define HID_TOOL_MOVE                           0x12713
#define HID_TOOL_TRANSFORM                      0x12714
#define HID_TOOL_RULER                          0x12715
#define HID_TOOL_BRUSH                          0x12716
#define HID_TOOL_ERASER                         0x12717
#define HID_TOOL_CLONE                          0x12718
#define HID_TOOL_FILL                           0x12719
#define HID_TOOL_GRADIENT                       0x1271A
#define HID_TOOL_TEXT                           0x1271B
#define HID_TOOL_DROPPER                        0x1271C
#define HID_TOOL_HAND                           0x1271D
#define HID_TOOL_ZOOM                           0x1271E
#define HID_ADJUSTMENTS_BRIGHTNESS              0x14E20
#define HID_ADJUSTMENTS_COLOURBALANCE           0x14E21
#define HID_ADJUSTMENTS_DESATURATE              0x14E22
#define HID_ADJUSTMENTS_BLACKWHITE              0x14E23
#define HID_ADJUSTMENTS_GRADIENTMAP             0x14E24
#define HID_ADJUSTMENTS_INVERT                  0x14E25
#define HID_ADJUSTMENTS_THRESHOLD               0x14E26
#define HID_ADJUSTMENTS_POSTERIZE               0x14E27
#define HID_ADJUSTMENTS_LEVELS                  0x14E28
#define HID_FILTER_BLUR                         0x14E34
#define HID_FILTER_MOTIONBLUR                   0x14E35
#define HID_FILTER_GAUSSIANBLUR                 0x14E36
#define HID_FILTER_ADDNOISE                     0x14E37
#define HID_FILTER_EMBOSS                       0x14E38
#define HID_FILTER_SHEAR                        0x14E39
#define HID_FILTER_SOLARIZE                     0x14E3A
#define HID_FILTER_OFFSET                       0x14E3B
#define HID_FILTER_PIXELATE                     0x14E3C
#define HID_FILTER_NIGHTVISION                  0x14E3D
#define HID_FILTER_HALFTONE                     0x14E3E
#define HID_FILTER_SHARPEN                      0x14E3F
#define HID_FILTER_UNSHARPMASK                  0x14E40
#define HID_FILTER_EDGES_ALL                    0x14E41
#define HID_FILTER_EDGES_HORIZONTAL             0x14E42
#define HID_FILTER_EDGES_VERTICAL               0x14E43
#define HID_FILTER_EDGES_DIAGONAL               0x14E44
#define HID_LAYER_BRIGHTNESS                    0x17530
#define HID_LAYER_COLOURBALANCE                 0x17531
#define HID_LAYER_DESATURATE                    0x17532
#define HID_LAYER_BLACKWHITE                    0x17533
#define HID_LAYER_GRADIENTMAP                   0x17534
#define HID_LAYER_INVERT                        0x17535
#define HID_LAYER_THRESHOLD                     0x17536
#define HID_LAYER_POSTERIZE                     0x17537
#define HID_LAYER_LEVELS                        0x17538
#define HID_EDIT_PURGEUNDO                      0x18005
#define HID_SELECT_ALL                          0x18006
#define HID_SELECT_DESELECT                     0x18007
#define HID_SELECT_INVERSE                      0x18008
#define HID_EDIT_SELECTALL                      0x18009
#define HID_IMAGE_CROP                          0x18010
#define HID_IMAGE_REVEALALL                     0x18011
#define HID_VIEW_ZOOMIN                         0x18012
#define HID_VIEW_ZOOMOUT                        0x18013
#define HID_VIEW_SCALETOFIT                     0x18014
#define HID_VIEW_ACTUALSIZE                     0x18015
#define HID_VIEW_FULLSCREEN                     0x18016
#define HID_IMAGE_CANVASSIZE                    0x18017
#define HID_WINDOW_COLOUR                       0x1802D
#define HID_WINDOW_LAYERS                       0x1802E
#define HID_WINDOW_TOOLS                        0x1802F
#define HID_LAYER_NEW                           0x18035
#define HID_NEW_LAYERVIACOPY                    0x18037
#define HID_NEW_LAYERVIACUT                     0x18038
#define HID_LAYER_DUPLICATELAYER                0x18039
#define HID_LAYER_PROPERTIES                    0x18042
#define HID_LAYER_DELETELAYER                   0x18043
#define HID_LAYER_DELETE                        0x18044
#define HID_LAYER_RENAMELAYER                   0x18046
#define HID_LAYER_RENAME                        0x18047
#define HID_EDIT_PURGECLIPBOARD                 0x1804B
#define HID_EDIT_PURGEALL                       0x1804D
#define HID_LAYER_ADDLAYERMASK                  0x18051
#define HID_LAYER_REMOVELAYERMASK               0x18052
#define HID_LAYER_ENABLELAYERMASK               0x18053
#define HID_EDIT_FILL                           0x18056
#define HID_IMAGE_IMAGESIZE                     0x18059
#define HID_IMAGE_FLIP                          0x1805C
#define HID_FLIP_HORIZONTAL                     0x1805D
#define HID_FLIP_VERTICAL                       0x1805E
#define HID_LAYER_MOVEUP                        0x1805F
#define HID_LAYER_MOVEDOWN                      0x18060
#define HID_FILE_EXTRACT                        0x18069
#define HID_SELECT_LAYERTRANSPARENCY            0x1806A
#define HID_LAYER_RASTERIZE                     0x1806F
#define HID_MODIFY_EXPAND                       0x18075
#define HID_MODIFY_CONTRACT                     0x18076
#define HID_MODIFY_FEATHER                      0x18077
#define HID_EDIT_FILL_FG                        0x1808A
#define HID_EDIT_FILL_BG                        0x1808B
#define HID_WINDOW_SCRIPTS                      0x1808C
#define HID_IMAGE_ROTATE                        0x18090
#define HID_ROTATE_90                           0x18091
#define HID_ROTATE_180                          0x18092
#define HID_ROTATE_270                          0x18093
#define HID_ROTATE_OTHER                        0x18094
#define HID_TRANSFORM_FLIPHORIZONTAL            0x18098
#define HID_TRANSFORM_FLIPVERTICAL              0x18099
#define HID_TRANSFORM_ROTATE90                  0x1809A
#define HID_TRANSFORM_ROTATE180                 0x1809B
#define HID_TRANSFORM_ROTATE270                 0x1809C
#define HID_TRANSFORM_ROTATEBYANGLE             0x1809D
#define HID_LAYER_MERGEDOWN                     0x180A0
#define HID_LAYER_FLATTENIMAGE                  0x180A1
#define HID_EDIT_PASTEEXTERNAL                  0x180A6
#define HID_PRESET                              0x180A8
#define HID_PRESET_A4                           0x180A9
#define HID_PRESET_A3                           0x180AA
#define HID_PRESET_A2                           0x180AB
#define HID_PRESET_LETTER                       0x180AC
#define HID_PRESET_CLIPBOARD                    0x180AD
#define HID_PRESET_WINDOWSCLIPBOARD             0x180AE
#define HID_PRESET_WINDOWS                      0x180AF
#define HID_APP_LANGUAGE                        0x180D7
 
// Prompts (IDP_*) 
 
// Resources (IDR_*) 
#define HIDR_MAINFRAME                          0x20080
#define HIDR_COLOR                              0x20080
#define HIDR_DOCTYPE                            0x20081
#define HIDR_SELECT                             0x20087
#define HIDR_TOOLS                              0x20088
#define HIDR_WAND                               0x20088
#define HIDR_LAYERS                             0x2008F
#define HIDR_POPUP                              0x2008F
#define HIDR_BRUSH                              0x20090
#define HIDR_DUMMY                              0x20091
#define HIDR_GRADIENT                           0x20096
#define HIDR_SCRIPTS                            0x200A1
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_NEWIMAGE                           0x20082
#define HIDD_CANVASSIZE                         0x20086
#define HIDD_ADJUST                             0x2008E
#define HIDD_INPUT                              0x20092
#define HIDD_FILL                               0x20093
#define HIDD_IMAGESIZE                          0x20094
#define HIDD_LAYER                              0x20095
#define HIDD_TEXT                               0x20097
#define HIDD_RAWIMPORT                          0x200A0
#define HIDD_JPEG_OPTIONS                       0x200B2
#define HIDD_RULER                              0x200B3
